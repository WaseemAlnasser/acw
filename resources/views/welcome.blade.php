...
<head>
    ...
    <link rel="icon" href="{{asset('theme/img/favicon/favicon.ico')}}" sizes="any">
    <link rel="icon" href="{{asset('theme/img/favicon/icon.svg')}}" type="image/svg+xml">
    <link rel="apple-touch-icon" href="{{asset('theme/img/favicon/apple-touch-icon.png')}}">
    <link rel="manifest" href="{{asset('theme/img/favicon/manifest.webmanifest')}}">
...
<div class="loader">
    <div class="loader__container">
        <lottie-player src="{{asset('theme/lottie/acw1.json')}}"   speed="1"   loop  autoplay></lottie-player>
    </div>
</div>
<!-- Loader End -->
                ...
                <div class="col-12 col-xl-8 menu__data">
                    <div class="menudata__copyright">
                        <div class="container-fluid p-0">
                            <div class="row g-0">
                                <div class="col-12">
                                    <p class="copyright">By <a href="https://acw.ae" target="_blank">ACW</a>, 2023</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-auto col-xl-8">
                    ...
                    <div class="header__buttons d-flex justify-content-end align-items-center">
                        ...
                        <div class="socials-desktop">
                            <ul>
                                <li>
                                    <a href="https://www.facebook.com/profile.php?id=100089797245604&mibextid=LQQJ4d" target="_blank">
                                        <i class="fa-brands fa-facebook"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/acw.ae/?igshid=YmMyMTA2M2Y%3D" target="_blank">
                                        <i class="fa-brands fa-instagram"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.pinterest.com/acw_ae/" target="_blank">
            ...
            <div class="row g-0 fullheight">
                ...
                <div class="col-12 col-xl-8 main__intro">
                    ...
                    <div class="intro__content">
                        ...
                        <div id="headline" class="headline">
                            ...
                            <h1 style="color: #5c548c">Stay tuned for something awesome.</h1>
                        </div>
                        <!-- Headline End -->
                ...
                <div class="col-12  col-xl-4 main__media">
                    ...
                    <div class="media__image media-image-2" style="">
                        <img src="{{asset('theme/img/web4.jpg')}}">
                    </div>
                </div>
    ...
    <div class="popup__container">
        ...
        <div class="popup__content block-rounded-l">
            ...
            <div class="form-container">
                ...
                <form method="post" action="{{route('subscribe')}}" class="form notify-form form-light">
                    @csrf
